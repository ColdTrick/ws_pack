<?php
	...
	function ws_pack_discussions_expose_functions() {
		expose_function("discussions.post",
		                "post_discussion",
						array(	
		                	"title" => array(
		                	"type" => "string",
		...
		expose_function("discussions.post_reply",
		                "post_reply",
						array(	
		                	"content" => array(
		                	"type" => "string",
		...
		expose_function("discussions.get_discussions",
		...
		expose_function("discussions.get_discussion",
		...
		expose_function("discussions.delete_discussion",
