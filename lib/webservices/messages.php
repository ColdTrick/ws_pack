<?php
	...
	function ws_pack_messages_expose_functions() {
		expose_function("messages.send_message",
		...
		expose_function("messages.get_messages",
		...
		expose_function("messages.get_conversation",
		...
		expose_function("messages.get_last_conversations",
		...
		expose_function("messages.delete_message",
